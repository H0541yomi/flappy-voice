...
{
    // UnityEngine.Microphone, i.e. everything except the Web player. Deliberately not compiled for
    // Web: starting a Unity recording there would open a second getUserMedia stream alongside the
    // jslib bridge's, and the clip it produces cannot be read while it is running anyway.
    internal sealed class UnityMicrophoneBackend : IMicrophoneBackend
    {
        ...
        public int DeviceCount => Microphone.devices != null ? Microphone.devices.Length : 0;
